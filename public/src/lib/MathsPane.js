...
// - Presents Jemima's snippets in a minimal stacked list without scroll containers.
...
//     MathsPane.mount(container, { round, roomCode, userUid });
//
...
export function mount(container, { round = 1, roomCode, userUid } = {}) {
  if (!container) return;
