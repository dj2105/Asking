...
export default {
  async mount(container) {
    ...
    const heading = el("div", { class: "mono phase-header__title marking-title" }, "MARKING");
    ...
    for (let i = 0; i < 3; i += 1) {
      ...
      const q = rawQuestion || fallback.question;
      const chosen = typeof oppAnswers[i] === "string" ? oppAnswers[i] : "";
