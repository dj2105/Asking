...
// • Both players must tap Continue; host advances to the next round or the final summary after R5.
...
export default {
  async mount(container) {
    ...
    const computeReadyLabel = (r) => (r >= 5 ? "I'M READY FOR THE FINAL" : `I'M READY FOR ROUND ${r + 1}`);
