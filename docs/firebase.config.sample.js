...
// your Firebase project credentials. Keep the `export default { … }` shape so
// GitHub Pages can import it as an ES module. These values are safe to commit;
// the client needs them to talk to Firebase from a static host.
//
